  ...
  const verTagSection = (
    <section className="panel-section">
      <p style={{ fontSize: 12, opacity: 0.7, lineHeight: 1.7, margin: 0 }}>
        版本 v4(2026-09-07)・⛶ <b>手機放大鈕</b>——右上角一顆放大鈕:收掉上方標題列、棋盤區吃滿螢幕;Android 會連瀏覽器網址列一起收掉,iPhone 不支援網頁全螢幕也照樣放得大;再按一次縮回。
        <br />
        前幾版:v3 🔗 網址加 ?daily 直接開每日殘局(信友火花「今日挑戰」卡點了就進今天的題,不用再按每日鈕)(2026-09-06)・v2 📅 每日殘局:每天一組 5 題、全世界同一組,最少步數內把棋子全走進對面營區,每題的最少步數都由電腦窮舉算過(2026-08-31)・v1 中國跳棋(對 AI 三檔/悔棋/棋譜回放/盤面編輯器/可分享連結/PWA)
      </p>
    </section>
  )
